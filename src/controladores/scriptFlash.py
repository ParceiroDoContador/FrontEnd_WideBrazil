...
codigo_categoria_flash = "1.01.03"
...
while linha_planilha < total_linhas:
    ...
    incluir_conta_pagar(codigo_cliente_omie, data_vencimento, flash, codigo_categoria=codigo_categoria_flash)
    incluir_conta_receber(codigo_cliente_omie, data_vencimento, flash, codigo_categoria=codigo_categoria_flash)
    linha_planilha += 1